...
const InfoCard = ({ title, value, icon: Icon, link }) => {
  const navigate = useNavigate()
  return (
    <div onClick={() => navigate(link)} className="cursor-pointer group rounded-2xl p-6 flex justify-between items-center bg-gray-50 dark:bg-neutral-950 border border-gray-100 dark:border-zinc-800 shadow-sm hover:shadow-2xl transition-all duration-300 ease-out hover:-translate-y-1.5 hover:bg-neutral-950 dark:hover:bg-white h-fit">
      <div>
