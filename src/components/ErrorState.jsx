...
const ErrorState = ({ onRetry, home = true, paddingY = "py-24" }) => {
  const navigate = useNavigate();
  return (
    <div
      className={clsx(
        "flex justify-center items-center flex-col gap-8 px-6 text-center dark:bg-black w-full",
        paddingY,
        paddingY === "py-24" && "h-screen",
      )}
    >
      <div className="flex flex-col items-center gap-2">
        ...
        <p className="text-gray-500 dark:text-gray-400 font-medium max-w-sm">
          We couldn't load data. It might be a temporary issue — please try
          again.
        </p>
      </div>
