      ...
      <div className="flex flex-wrap gap-4 justify-between items-center">
        <div className="flex gap-x-4 items-center">
          <div className="relative shrink-0">
            ...
            />
            {you && (
              <span className="absolute -bottom-1 -right-1 bg-blue-600 text-white text-[10px] font-semibold px-1.5 py-0.5 rounded-full border-2 border-white dark:border-zinc-950">
                You
              </span>
            )}
          </div>
