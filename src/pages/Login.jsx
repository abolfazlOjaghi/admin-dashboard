...
const Login = () => {
  ...
  return (
    <section className="h-screen w-screen flex justify-center items-center dark:bg-black bg-gray-50 px-4 dark:text-white">
      <div className="w-full max-w-sm bg-white dark:bg-zinc-950 rounded-2xl shadow-sm border border-gray-100 dark:border-zinc-800 p-8 space-y-6">
        ...
        <form className="space-y-1.5" onSubmit={handleSubmit(handlesubmitLoginForm)}>
          ...
          <button
            type="submit"
            className="w-full bg-blue-600 hover:bg-blue-700 text-white rounded-xl py-2.5 font-medium cursor-pointer transition-colors mt-2"
          >
            Sign in
          </button>
        </form>
